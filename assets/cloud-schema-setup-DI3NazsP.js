import{vt as e,xt as t}from"./store-BcaQ2Nkm.js";import{r as n}from"./utils-dB6sohNZ.js";import{B as r,D as i,J as a,K as o}from"./index-ZOgdZfAF.js";var s=t(e(),1),c=`-- Hotel Status Residency — per-user cash book
...
grant select, insert, update, delete
  ...
  public.balance_received, public.guests, public.food, public.wholesale, public.advances
  to authenticated;
`,l=`-- Hotel logins created by Admin (name, username, password, role).
...
create policy "advances_own" on public.advances
  ...
  using (user_id = public.hotel_owner_id())
  with check (user_id = public.hotel_owner_id());
`,u=`-- App roles live in public.users. After login the client reads role here.
...
`,d=`-- Strong RLS: owner from public.users (not JWT metadata).
...
revoke all on function public.login_hotel_user(text, text) from public;
grant execute on function public.login_hotel_user(text, text) to anon, authenticated;
`,f=`-- Opening balance already lives on ledger_meta.opening / opening_date.
...
`,p=`-- Saved entries stay frozen on every desk.
...
create policy "sheet_seals_delete" on public.sheet_seals
  for delete to authenticated
  using (user_id = public.hotel_owner_id());
`,m=`-- Daily register Save cube was hitting "permission denied" because
...
`,h=n();function g({userId:e}){let[t,n]=(0,s.useState)(!1);return(0,h.jsxs)(`div`,{className:`flex flex-wrap gap-2`,children:[(0,h.jsx)(i,{type:`button`,onClick:()=>{navigator.clipboard.writeText(`${c}\n\n${l}\n\n${u}\n\n${d}\n\n${f}\n\n${p}\n\n${m}`).then(()=>o.success(`SQL copied. Paste it in the SQL editor, run it, then retry.`),()=>o.error(`Could not copy SQL`))},children:`Copy table SQL`}),(0,h.jsx)(i,{type:`button`,variant:`outline`,asChild:!0,children:(0,h.jsx)(`a`,{href:a,target:`_blank`,rel:`noreferrer`,children:`Open SQL editor`})}),e?(0,h.jsx)(i,{type:`button`,variant:`outline`,disabled:t,onClick:()=>{n(!0),r(e).finally(()=>n(!1))},children:t?`Checking…`:`Tables are ready`}):null]})}export{u as n,l as r,g as t};