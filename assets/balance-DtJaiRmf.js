import{$ as e,Dt as t,Ft as n,Gt as r,Ht as i,Ot as a,St as o,Y as s,bt as c,i as l,r as u,yt as d}from"./store-BnB8Te8t.js";import{r as f,t as p}from"./utils-CarG3POp.js";import{a as m,i as h,n as g,o as _,r as v,s as y,t as b}from"./select-CH0j-ZYN.js";import{t as x}from"./printer-C4nuRXlw.js";import{t as S}from"./search-BGN8Zsv0.js";import{t as C}from"./trash-2-BPebDMkV.js";import{D as w,J as T,a as E,i as D,o as O,tt as k}from"./index-C3sVGckK.js";import{t as A}from"./badge-C72QYTNi.js";import{n as j,t as M}from"./card-CaYmGjVk.js";import{i as N,n as P,r as F,t as I}from"./tabs-BIEaIurt.js";import{t as L}from"./mode-badge-LTTJsn7O.js";import{i as R,n as z,r as B,t as V}from"./balance-tFF5xRa3.js";import{t as H}from"./print-sheet-WW0K3WOT.js";import{n as U,t as ee}from"./save-cube-DVgKEipE.js";var W=r(i());function G(e){return Math.round(e).toLocaleString(`en-IN`)}function K(e){return e.checkOut?n(e.checkOut):`Continue`}function q(e){return e.status===`paid`?`✓ Paid`:e.status===`partial`?`Partial · ${G(e.remaining)}`:`Open`}function J(e,t){let n=`<!doctype html>
<html>
<head>
  <meta charset="utf-8" />
  <title>${H(e)}</title>
