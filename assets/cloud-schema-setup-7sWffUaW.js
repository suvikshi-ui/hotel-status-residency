import{Gt as e,Ht as t}from"./store-BticIPby.js";import{r as n}from"./utils-BzL8tx6P.js";import{D as r,V as i,et as a,rt as o}from"./index-CAliAfJ3.js";import{n as s,t as c}from"./0009_desk_can_save-nl1VR0ed.js";var l=e(t(),1),u=`-- Hotel Status Residency — per-user cash book
...
revoke all on function public.hotel_owner_id() from public, anon;
grant execute on function public.hotel_owner_id() to authenticated;
`,S=n();function C({userId:e}){let[t,n]=(0,l.useState)(!1);return(0,S.jsxs)(`div`,{className:`flex flex-wrap gap-2`,children:[(0,S.jsx)(r,{type:`button`,onClick:()=>{let e=`${u}\n\n${d}\n\n${f}\n\n${p}\n\n${m}\n\n${h}\n\n${g}\n\n${c}\n\n${_}\n\n${v}\n\n${y}\n\n${b}\n\n${x}`;s(e)?a.success(`SQL copied. Paste it in the SQL editor, run it, then retry.`):a.error(`Copy blocked on this computer. Open the SQL box on Register instead.`)},children:`Copy table SQL`}),(0,S.jsx)(r,{type:`button`,variant:`outline`,asChild:!0,children:(0,S.jsx)(`a`,{href:o,target:`_blank`,rel:`noreferrer`,children:`Open SQL editor`})}),e?(0,S.jsx)(r,{type:`button`,variant:`outline`,disabled:t,onClick:()=>{n(!0),i(e).finally(()=>n(!1))},children:t?`Checking…`:`Tables are ready`}):null]})}export{d as a,f as i,b as n,y as r,C as t};