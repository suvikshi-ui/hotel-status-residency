import{Bt as e,Et as t,Nt as n,Tt as r,Ut as i,Z as a,_t as o,bt as s,i as c,q as l,r as u,vt as d}from"./store-BgbyUXbL.js";import{r as f,t as p}from"./utils-C6iSnbQ9.js";import{a as m,i as h,n as g,o as _,r as v,s as y,t as b}from"./select-LO9Yh7Pb.js";import{t as x}from"./printer-B5w2T3c_.js";import{t as S}from"./search-uEgmI5nw.js";import{t as C}from"./trash-2-U_PZFUfj.js";import{D as w,J as T,a as E,i as D,o as O,tt as k}from"./index-C4yflLZA.js";import{t as A}from"./badge-Yf4JWHs4.js";import{n as j,t as M}from"./card-B5YApmAX.js";import{i as N,n as P,r as F,t as I}from"./tabs-CvWyAx4c.js";import{t as L}from"./mode-badge-BNUZDcSp.js";import{i as R,n as z,r as B,t as V}from"./balance-Dir5Ewh-.js";import{t as H}from"./print-sheet-CFzPCQHL.js";import{n as U,t as ee}from"./save-cube-BygN4Yau.js";var W=i(e());function G(e){return Math.round(e).toLocaleString(`en-IN`)}function K(e){return e.checkOut?n(e.checkOut):`Continue`}function q(e){return e.status===`paid`?`✓ Paid`:e.status===`partial`?`Partial · ${G(e.remaining)}`:`Open`}function J(e,t){let n=`<!doctype html>
<html>
<head>
  <meta charset="utf-8" />
  <title>${H(e)}</title>
