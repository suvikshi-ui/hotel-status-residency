...
</html>`)}var i={width:794,height:1123,marginMm:8},a=`https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,500;9..144,600;9..144,700&family=Source+Serif+4:opsz,wght@8..60,500;8..60,600;8..60,700&display=swap`,o=`@page { size: A4 portrait; margin: 8mm; background: #fff; }
html, body {
  margin: 0;
