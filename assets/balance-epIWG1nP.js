import{A as e,P as t,St as n,ct as r,et as i,ft as a,i as o,lt as s,r as c,rt as l,tt as u,yt as d}from"./store-CRr6lvuQ.js";import{r as f,t as p}from"./utils-B0jTBOIr.js";import{a as m,i as h,n as g,o as _,r as v,s as y,t as b}from"./select-DRHdfSTp.js";import{t as x}from"./printer-DAktxgJM.js";import{a as S,i as C,n as w,r as T,t as E}from"./balance-BG6AlCNj.js";import{t as D}from"./trash-2-U26uf_SZ.js";import{D as O,a as k,et as A,i as j,o as M,q as N}from"./index-CcpcIg3T.js";import{t as P}from"./badge-Bx7f_LJ6.js";import{n as F,t as I}from"./card-BvcUkvRQ.js";import{i as L,n as R,r as ee,t as te}from"./tabs-2u5dxVtY.js";import{t as z}from"./mode-badge-Bj7Ocykf.js";import{t as B}from"./print-sheet-DRGqd10H.js";import{n as V,t as H}from"./save-cube-CWi62vxq.js";var U=n(d());function W(e){return Math.round(e).toLocaleString(`en-IN`)}function G(e){return e.checkOut?a(e.checkOut):`Continue`}function K(e){return e.status===`paid`?`✓ Paid`:e.status===`partial`?`Partial · ${W(e.remaining)}`:`Open`}function q(e,t){let n=`<!doctype html>
<html>
<head>
  <meta charset="utf-8" />
  <title>${B(e)}</title>
