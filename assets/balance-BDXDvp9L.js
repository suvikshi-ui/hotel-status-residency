import{A as e,C as t,I as n,N as r,O as i,g as a,i as o,k as s,r as c,v as l,w as u}from"./store-G_9N-FRE.js";import{n as d}from"./dist-DNN4Szzp.js";import{r as f,t as p}from"./utils-DuW_DAKh.js";import{a as m,c as h,d as g,f as _,i as v,l as y,n as b,o as x,r as S,s as C,t as w,u as T}from"./balance-Db45JDBK.js";import{t as E}from"./printer-DMEF8dc0.js";import{t as D}from"./trash-2-Gr8LNr3g.js";import{E as O,M as k,a as A,i as j,t as M}from"./index-BFz1k6WD.js";import{t as N}from"./badge-Cq1S618K.js";import{n as P,t as F}from"./card-CFieMxO8.js";import{i as I,n as L,r as R,t as z}from"./tabs-CZd8kG24.js";import{t as B}from"./mode-badge-COnb_pFT.js";import{t as V}from"./print-sheet-1InZJ50L.js";var H=n(r());function U(t){try{let n=i(t);return e(n)?s(n,`dd/MM/yy`):t}catch{return t}}function W(e){return Math.round(e).toLocaleString(`en-IN`)}function G(e){return e.checkOut?U(e.checkOut):`In house`}function K(e){return e.status===`paid`?`✓ Paid`:e.status===`partial`?`Partial · ${W(e.remaining)}`:`Open`}function q(e,t){let n=`<!doctype html>
<html>
<head>
  <meta charset="utf-8" />
  <title>${V(e)}</title>
