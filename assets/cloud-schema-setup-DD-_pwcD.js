import{vt as e,xt as t}from"./store-ETBT_9Dr.js";import{r as n}from"./utils-Y-js6SrU.js";import{B as r,D as i,Y as a,q as o}from"./index-hH6E2TUE.js";import{t as s}from"./0009_desk_can_save-3Z0u_l0X.js";var c=t(e(),1),l=`-- Hotel Status Residency — per-user cash book
...
grant select, insert, update, delete
  ...
  public.balance_received, public.guests, public.food, public.wholesale, public.advances
  to authenticated;
`,u=`-- Hotel logins created by Admin (name, username, password, role).
...
create policy "advances_own" on public.advances
  ...
  using (user_id = public.hotel_owner_id())
  with check (user_id = public.hotel_owner_id());
`,d=`-- App roles live in public.users. After login the client reads role here.
...
`,f=`-- Strong RLS: owner from public.users (not JWT metadata).
...
revoke all on function public.login_hotel_user(text, text) from public;
grant execute on function public.login_hotel_user(text, text) to anon, authenticated;
`,p=`-- Opening balance already lives on ledger_meta.opening / opening_date.
...
`,m=`-- Saved entries stay frozen on every desk.
...
create policy "sheet_seals_delete" on public.sheet_seals
  for delete to authenticated
  using (user_id = public.hotel_owner_id());
`,h=`-- Daily register Save cube was hitting "permission denied" because
...
`,g=n();function _({userId:e}){let[t,n]=(0,c.useState)(!1);return(0,g.jsxs)(`div`,{className:`flex flex-wrap gap-2`,children:[(0,g.jsx)(i,{type:`button`,onClick:()=>{navigator.clipboard.writeText(`${l}\n\n${u}\n\n${d}\n\n${f}\n\n${p}\n\n${m}\n\n${h}\n\n${s}`).then(()=>o.success(`SQL copied. Paste it in the SQL editor, run it, then retry.`),()=>o.error(`Could not copy SQL`))},children:`Copy table SQL`}),(0,g.jsx)(i,{type:`button`,variant:`outline`,asChild:!0,children:(0,g.jsx)(`a`,{href:a,target:`_blank`,rel:`noreferrer`,children:`Open SQL editor`})}),e?(0,g.jsx)(i,{type:`button`,variant:`outline`,disabled:t,onClick:()=>{n(!0),r(e).finally(()=>n(!1))},children:t?`Checking…`:`Tables are ready`}):null]})}export{d as n,u as r,_ as t};