import{J as e,Z as t}from"./store-HsmgQ9FS.js";import{n}from"./dist-CZNyeOli.js";import{r}from"./utils-_K_YIVsM.js";import{l as i,n as a}from"./supabase-sync-CEZnPYrT.js";import{w as o}from"./index-CNaizUCf.js";var s=t(e(),1),c=`-- Hotel Status Residency — per-user cash book
...
create policy "advances_own" on public.advances
  ...
  using (user_id = public.hotel_owner_id())
  with check (user_id = public.hotel_owner_id());
`,u=r();function d({userId:e}){let[t,r]=(0,s.useState)(!1);return(0,u.jsxs)(`div`,{className:`flex flex-wrap gap-2`,children:[(0,u.jsx)(o,{type:`button`,onClick:()=>{navigator.clipboard.writeText(`${c}\n\n${l}`).then(()=>n.success(`SQL copied. Paste it in the SQL editor, run it, then retry.`),()=>n.error(`Could not copy SQL`))},children:`Copy table SQL`}),(0,u.jsx)(o,{type:`button`,variant:`outline`,asChild:!0,children:(0,u.jsx)(`a`,{href:i,target:`_blank`,rel:`noreferrer`,children:`Open SQL editor`})}),e?(0,u.jsx)(o,{type:`button`,variant:`outline`,disabled:t,onClick:()=>{r(!0),a(e).finally(()=>r(!1))},children:t?`Checking…`:`Tables are ready`}):null]})}export{d as t};