import{r as e}from"./rolldown-runtime-hePW80VL.js";import{$ as t}from"./store-DyCW_7hI.js";import{B as n,D as r,H as i,I as a,Z as o}from"./index-BqP0TC9k.js";var s=e(t(),1),c=`-- Hotel Status Residency — per-user cash book
...
revoke all on function public.login_hotel_user(text, text) from public;
grant execute on function public.login_hotel_user(text, text) to anon, authenticated;
`,f=o();function p({userId:e}){let[t,o]=(0,s.useState)(!1);return(0,f.jsxs)(`div`,{className:`flex flex-wrap gap-2`,children:[(0,f.jsx)(r,{type:`button`,onClick:()=>{navigator.clipboard.writeText(`${c}\n\n${l}\n\n${u}\n\n${d}`).then(()=>n.success(`SQL copied. Paste it in the SQL editor, run it, then retry.`),()=>n.error(`Could not copy SQL`))},children:`Copy table SQL`}),(0,f.jsx)(r,{type:`button`,variant:`outline`,asChild:!0,children:(0,f.jsx)(`a`,{href:i,target:`_blank`,rel:`noreferrer`,children:`Open SQL editor`})}),e?(0,f.jsx)(r,{type:`button`,variant:`outline`,disabled:t,onClick:()=>{o(!0),a(e).finally(()=>o(!1))},children:t?`Checking…`:`Tables are ready`}):null]})}export{p as t};