import{Bt as e,Et as t,Nt as n,Tt as r,Ut as i,Z as a,_t as o,bt as s,i as c,q as l,r as u,vt as d}from"./store-DYvgfZYr.js";import{r as f,t as p}from"./utils-CHSaYwj3.js";import{a as m,i as h,n as g,o as _,r as v,s as y,t as b}from"./select-CH2ligov.js";import{t as x}from"./printer-adBBugXx.js";import{t as S}from"./search-B0FRt4Ko.js";import{t as C}from"./trash-2-DC365u-S.js";import{D as w,J as T,a as E,i as D,o as O,tt as k}from"./index-Dp3Us4L4.js";import{t as A}from"./badge-CRVPif-s.js";import{n as j,t as M}from"./card-COR-ZK5g.js";import{i as N,n as P,r as F,t as I}from"./tabs-C11R2J8W.js";import{t as L}from"./mode-badge-RxpNKbzT.js";import{i as R,n as z,r as B,t as V}from"./balance-C1ARhCAJ.js";import{t as H}from"./print-sheet-B1gB-kPf.js";import{n as U,t as ee}from"./save-cube-DdiOMBkF.js";var W=i(e());function G(e){return Math.round(e).toLocaleString(`en-IN`)}function K(e){return e.checkOut?n(e.checkOut):`Continue`}function q(e){return e.status===`paid`?`✓ Paid`:e.status===`partial`?`Partial · ${G(e.remaining)}`:`Open`}function J(e,t){let n=`<!doctype html>
<html>
<head>
  <meta charset="utf-8" />
  <title>${H(e)}</title>
