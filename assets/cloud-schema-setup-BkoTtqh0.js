import{J as e,Z as t}from"./store-C1bpIcfi.js";import{J as n,L as r,N as i,w as a,z as o}from"./index-jazGc40E.js";var s=t(e(),1),c=`-- Hotel Status Residency — per-user cash book
...
`,d=n();function f({userId:e}){let[t,n]=(0,s.useState)(!1);return(0,d.jsxs)(`div`,{className:`flex flex-wrap gap-2`,children:[(0,d.jsx)(a,{type:`button`,onClick:()=>{navigator.clipboard.writeText(`${c}\n\n${l}\n\n${u}`).then(()=>r.success(`SQL copied. Paste it in the SQL editor, run it, then retry.`),()=>r.error(`Could not copy SQL`))},children:`Copy table SQL`}),(0,d.jsx)(a,{type:`button`,variant:`outline`,asChild:!0,children:(0,d.jsx)(`a`,{href:o,target:`_blank`,rel:`noreferrer`,children:`Open SQL editor`})}),e?(0,d.jsx)(a,{type:`button`,variant:`outline`,disabled:t,onClick:()=>{n(!0),i(e).finally(()=>n(!1))},children:t?`Checking…`:`Tables are ready`}):null]})}export{f as t};