import{Dt as e,Et as t,Pt as n,Q as r,Vt as i,Wt as a,Y as o,i as s,r as c,vt as l,xt as u,yt as d}from"./store-BKtc42Qt.js";import{r as f,t as p}from"./utils-Clex_ohm.js";import{a as m,i as h,n as g,o as _,r as v,s as y,t as b}from"./select-D0QA1KOk.js";import{t as x}from"./printer-Cw_Gswlp.js";import{t as S}from"./search-BCfRTLhM.js";import{t as C}from"./trash-2-C2ThYstZ.js";import{D as w,J as T,a as E,i as D,o as O,tt as k}from"./index-D5reisei.js";import{t as A}from"./badge-sIEKh_MM.js";import{n as j,t as M}from"./card-BJ-tlDUm.js";import{i as N,n as P,r as F,t as ee}from"./tabs-BH-T-Z0r.js";import{t as I}from"./mode-badge-DUZetqUM.js";import{i as L,n as R,r as z,t as B}from"./balance-CialVwKT.js";import{t as V}from"./print-sheet-D6Lidlyk.js";import{n as H,t as U}from"./save-cube-BZ4GtE05.js";var W=a(i());function G(e){return Math.round(e).toLocaleString(`en-IN`)}function K(e){return e.checkOut?n(e.checkOut):`Continue`}function q(e){return e.status===`paid`?`✓ Paid`:e.status===`partial`?`Partial · ${G(e.remaining)}`:`Open`}function J(e,t){let n=`<!doctype html>
<html>
<head>
  <meta charset="utf-8" />
  <title>${V(e)}</title>
