import{r as e}from"./rolldown-runtime-hePW80VL.js";import{Q as t}from"./store-Dtrr15Bh.js";import{B as n,D as r,H as i,I as a,Z as o}from"./index-BWyHM_go.js";var s=e(t(),1),c=`-- Hotel Status Residency — per-user cash book
...
`,d=o();function f({userId:e}){let[t,o]=(0,s.useState)(!1);return(0,d.jsxs)(`div`,{className:`flex flex-wrap gap-2`,children:[(0,d.jsx)(r,{type:`button`,onClick:()=>{navigator.clipboard.writeText(`${c}\n\n${l}\n\n${u}`).then(()=>n.success(`SQL copied. Paste it in the SQL editor, run it, then retry.`),()=>n.error(`Could not copy SQL`))},children:`Copy table SQL`}),(0,d.jsx)(r,{type:`button`,variant:`outline`,asChild:!0,children:(0,d.jsx)(`a`,{href:i,target:`_blank`,rel:`noreferrer`,children:`Open SQL editor`})}),e?(0,d.jsx)(r,{type:`button`,variant:`outline`,disabled:t,onClick:()=>{o(!0),a(e).finally(()=>o(!1))},children:t?`Checking…`:`Tables are ready`}):null]})}export{f as t};