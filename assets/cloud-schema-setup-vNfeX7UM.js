import{r as e}from"./rolldown-runtime-hePW80VL.js";import{an as t}from"./store-B0posp3E.js";import{r as n}from"./utils-CL4fqdWd.js";import{H as r,O as i,it as a,tt as o}from"./index-CEVFa92R.js";import{n as s,t as c}from"./0009_desk_can_save-nl1VR0ed.js";var l=e(t(),1),u=`-- Hotel Status Residency — per-user cash book
...
`,w=n();function T({userId:e}){let[t,n]=(0,l.useState)(!1);return(0,w.jsxs)(`div`,{className:`flex flex-wrap gap-2`,children:[(0,w.jsx)(i,{type:`button`,onClick:()=>{let e=`${u}\n\n${d}\n\n${f}\n\n${p}\n\n${m}\n\n${h}\n\n${g}\n\n${c}\n\n${_}\n\n${v}\n\n${y}\n\n${b}\n\n${x}\n\n${S}\n\n${C}`;s(e)?o.success(`SQL copied. Paste it in the SQL editor, run it, then retry.`):o.error(`Copy blocked on this computer. Open the SQL box on Register instead.`)},children:`Copy table SQL`}),(0,w.jsx)(i,{type:`button`,variant:`outline`,asChild:!0,children:(0,w.jsx)(`a`,{href:a,target:`_blank`,rel:`noreferrer`,children:`Open SQL editor`})}),e?(0,w.jsx)(i,{type:`button`,variant:`outline`,disabled:t,onClick:()=>{n(!0),r(e).finally(()=>n(!1))},children:t?`Checking…`:`Tables are ready`}):null]})}export{d as a,f as i,b as n,y as r,T as t};