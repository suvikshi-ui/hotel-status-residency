import{A as e,B as t,D as n,E as r,L as i,i as a,r as o,v as s,x as c,y as l}from"./store-DY_UMfT5.js";import{n as u}from"./dist-DD_2LsxA.js";import{r as d,t as f}from"./utils-D7wukrTQ.js";import{a as p,c as m,d as h,f as g,i as _,l as v,n as y,o as b,r as x,s as S,t as C,u as w}from"./balance-CtAuYHMw.js";import{t as T}from"./printer-DjhrJg88.js";import{t as E}from"./trash-2-BjyUJcd-.js";import{E as D,M as O,a as k,i as A,t as j}from"./index-DikDe5Gu.js";import{t as M}from"./badge-D52w5q4x.js";import{n as N,t as P}from"./card-pWDypV8a.js";import{i as F,n as I,r as L,t as R}from"./tabs-Bhj8uNu3.js";import{t as z}from"./mode-badge-D5xdV8PY.js";import{t as B}from"./print-sheet-x70MlCWt.js";var V=t(i());function H(e){return Math.round(e).toLocaleString(`en-IN`)}function U(t){return t.checkOut?e(t.checkOut):`In house`}function W(e){return e.status===`paid`?`✓ Paid`:e.status===`partial`?`Partial · ${H(e.remaining)}`:`Open`}function G(e,t){let n=`<!doctype html>
<html>
<head>
  <meta charset="utf-8" />
  <title>${B(e)}</title>
