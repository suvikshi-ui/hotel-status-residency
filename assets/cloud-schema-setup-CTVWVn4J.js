import{J as e,Z as t}from"./store-C4liFJ5g.js";import{n}from"./dist-hvETK0nd.js";import{r}from"./utils-FGRvfmJN.js";import{l as i,n as a}from"./supabase-sync-9Egojnv1.js";import{w as o}from"./index-CzMTZNot.js";var s=t(e(),1),c=`-- Hotel Status Residency — per-user cash book
...
`,d=r();function f({userId:e}){let[t,r]=(0,s.useState)(!1);return(0,d.jsxs)(`div`,{className:`flex flex-wrap gap-2`,children:[(0,d.jsx)(o,{type:`button`,onClick:()=>{navigator.clipboard.writeText(`${c}\n\n${l}\n\n${u}`).then(()=>n.success(`SQL copied. Paste it in the SQL editor, run it, then retry.`),()=>n.error(`Could not copy SQL`))},children:`Copy table SQL`}),(0,d.jsx)(o,{type:`button`,variant:`outline`,asChild:!0,children:(0,d.jsx)(`a`,{href:i,target:`_blank`,rel:`noreferrer`,children:`Open SQL editor`})}),e?(0,d.jsx)(o,{type:`button`,variant:`outline`,disabled:t,onClick:()=>{r(!0),a(e).finally(()=>r(!1))},children:t?`Checking…`:`Tables are ready`}):null]})}export{f as t};