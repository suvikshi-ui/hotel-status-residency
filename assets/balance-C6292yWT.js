import{A as e,J as t,L as n,M as r,R as i,V as a,Z as o,i as s,k as c,r as l}from"./store-HsmgQ9FS.js";import{n as u}from"./dist-CZNyeOli.js";import{r as d,t as f}from"./utils-_K_YIVsM.js";import{a as p,i as m,n as h,o as g,r as _,s as v,t as y}from"./select-BWp1Uggd.js";import{t as b}from"./printer-BaB5dHfV.js";import{a as x,i as S,n as C,r as w,t as T}from"./balance-gMucxAnh.js";import{t as E}from"./trash-2-D7ftRGpG.js";import{P as D,n as O,r as k,t as A,w as j}from"./index-CNaizUCf.js";import{t as M}from"./badge-C6EAKol6.js";import{n as N,t as P}from"./card-Dh3RtUeg.js";import{i as F,n as I,r as L,t as R}from"./tabs-D2tjgzL-.js";import{t as z}from"./mode-badge-DDEV_tmi.js";import{t as B}from"./print-sheet-CF_Nfcpu.js";var V=o(t());function H(e){return Math.round(e).toLocaleString(`en-IN`)}function U(e){return e.checkOut?a(e.checkOut):`Continue`}function W(e){return e.status===`paid`?`✓ Paid`:e.status===`partial`?`Partial · ${H(e.remaining)}`:`Open`}function G(e,t){let n=`<!doctype html>
<html>
<head>
  <meta charset="utf-8" />
  <title>${B(e)}</title>
