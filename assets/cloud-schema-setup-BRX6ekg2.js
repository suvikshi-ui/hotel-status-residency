import{C as e,D as t,w as n}from"./store-CCXaeVGH.js";import{A as r,D as i,M as a,S as o}from"./index-UEiNkfXH.js";var s=t(n(),1),c=`-- Hotel Status Residency — per-user cash book
...
grant select, insert, update, delete
  ...
  public.balance_received, public.guests, public.food, public.wholesale, public.advances
  to authenticated;
`,l=e();function u({userId:e}){let[t,n]=(0,s.useState)(!1);return(0,l.jsxs)(`div`,{className:`flex flex-wrap gap-2`,children:[(0,l.jsx)(o,{type:`button`,onClick:()=>{navigator.clipboard.writeText(c).then(()=>r.success(`SQL copied. Paste it in the SQL editor, run it, then retry.`),()=>r.error(`Could not copy SQL`))},children:`Copy table SQL`}),(0,l.jsx)(o,{type:`button`,variant:`outline`,asChild:!0,children:(0,l.jsx)(`a`,{href:a,target:`_blank`,rel:`noreferrer`,children:`Open SQL editor`})}),e?(0,l.jsx)(o,{type:`button`,variant:`outline`,disabled:t,onClick:()=>{n(!0),i(e).finally(()=>n(!1))},children:t?`Checking…`:`Tables are ready`}):null]})}export{u as t};