import{A as e,B as t,D as n,E as r,L as i,i as a,r as o,v as s,x as c,y as l}from"./store-QyD-aOsv.js";import{n as u}from"./dist-D3wP6nCc.js";import{r as d,t as f}from"./utils-D-jh0k_b.js";import{a as p,c as m,d as h,f as g,i as _,l as v,n as y,o as b,r as x,s as S,t as C,u as w}from"./balance-CNz7Aisf.js";import{t as T}from"./printer-DDFooFCY.js";import{t as E}from"./trash-2-KQfOelye.js";import{E as D,M as O,a as k,i as A,t as j}from"./index-CTggQJx6.js";import{t as M}from"./badge-DrsZZ3F3.js";import{n as N,t as P}from"./card-CtI1_oRf.js";import{i as F,n as I,r as L,t as R}from"./tabs-CanSTX4p.js";import{t as z}from"./mode-badge-DG6AVbUA.js";import{t as B}from"./print-sheet-CGmgJbOj.js";var V=t(i());function H(e){return Math.round(e).toLocaleString(`en-IN`)}function U(t){return t.checkOut?e(t.checkOut):`Continue`}function W(e){return e.status===`paid`?`✓ Paid`:e.status===`partial`?`Partial · ${H(e.remaining)}`:`Open`}function G(e,t){let n=`<!doctype html>
<html>
<head>
  <meta charset="utf-8" />
  <title>${B(e)}</title>
