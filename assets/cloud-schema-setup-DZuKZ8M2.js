import{gt as e,yt as t}from"./store-Bs0APfYz.js";import{r as n}from"./utils-BEdGVPdA.js";import{B as r,D as i,J as a,K as o}from"./index-BeBxUgOX.js";var s=t(e(),1),c=`-- Hotel Status Residency — per-user cash book
...
create policy "sheet_seals_delete" on public.sheet_seals
  for delete to authenticated
  using (user_id = public.hotel_owner_id());
`,m=n();function h({userId:e}){let[t,n]=(0,s.useState)(!1);return(0,m.jsxs)(`div`,{className:`flex flex-wrap gap-2`,children:[(0,m.jsx)(i,{type:`button`,onClick:()=>{navigator.clipboard.writeText(`${c}\n\n${l}\n\n${u}\n\n${d}\n\n${f}\n\n${p}`).then(()=>o.success(`SQL copied. Paste it in the SQL editor, run it, then retry.`),()=>o.error(`Could not copy SQL`))},children:`Copy table SQL`}),(0,m.jsx)(i,{type:`button`,variant:`outline`,asChild:!0,children:(0,m.jsx)(`a`,{href:a,target:`_blank`,rel:`noreferrer`,children:`Open SQL editor`})}),e?(0,m.jsx)(i,{type:`button`,variant:`outline`,disabled:t,onClick:()=>{n(!0),r(e).finally(()=>n(!1))},children:t?`Checking…`:`Tables are ready`}):null]})}export{u as n,l as r,h as t};