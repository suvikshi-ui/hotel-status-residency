import{ot as e,rt as t}from"./store-Cz1O0eoD.js";import{D as n,I as r,Q as i,U as a,V as o}from"./index-F5KERTbM.js";var s=e(t(),1),c=`-- Hotel Status Residency — per-user cash book
...
revoke all on function public.login_hotel_user(text, text) from public;
grant execute on function public.login_hotel_user(text, text) to anon, authenticated;
`,f=i();function p({userId:e}){let[t,i]=(0,s.useState)(!1);return(0,f.jsxs)(`div`,{className:`flex flex-wrap gap-2`,children:[(0,f.jsx)(n,{type:`button`,onClick:()=>{navigator.clipboard.writeText(`${c}\n\n${l}\n\n${u}\n\n${d}`).then(()=>o.success(`SQL copied. Paste it in the SQL editor, run it, then retry.`),()=>o.error(`Could not copy SQL`))},children:`Copy table SQL`}),(0,f.jsx)(n,{type:`button`,variant:`outline`,asChild:!0,children:(0,f.jsx)(`a`,{href:a,target:`_blank`,rel:`noreferrer`,children:`Open SQL editor`})}),e?(0,f.jsx)(n,{type:`button`,variant:`outline`,disabled:t,onClick:()=>{i(!0),r(e).finally(()=>i(!1))},children:t?`Checking…`:`Tables are ready`}):null]})}export{p as t};