import{A as e,C as t,I as n,N as r,O as i,g as a,i as o,k as s,r as c,v as l,w as u}from"./store-Do19rquq.js";import{n as d}from"./dist-Bnz8M9li.js";import{r as f,t as p}from"./utils-DNp9NB9t.js";import{a as m,c as h,d as g,f as _,i as v,l as y,n as b,o as x,r as S,s as C,t as w,u as T}from"./balance-lwhTkK5s.js";import{t as E}from"./printer-CKrm0Yyn.js";import{t as D}from"./trash-2-Bne3DBSy.js";import{E as O,M as k,a as A,i as j,t as M}from"./index-DN1Ejsla.js";import{t as N}from"./badge-DIKCa5J4.js";import{n as P,t as F}from"./card-DNLeez8k.js";import{i as I,n as L,r as R,t as z}from"./tabs-B-yB5bnP.js";import{t as B}from"./mode-badge-C-0tlMY1.js";import{t as V}from"./print-sheet-DiT6NFwB.js";var H=n(r());function U(t){try{let n=i(t);return e(n)?s(n,`dd/MM/yy`):t}catch{return t}}function W(e){return Math.round(e).toLocaleString(`en-IN`)}function G(e){return e.checkOut?U(e.checkOut):`In house`}function K(e){return e.status===`paid`?`✓ Paid`:e.status===`partial`?`Partial · ${W(e.remaining)}`:`Open`}function q(e,t){let n=`<!doctype html>
<html>
<head>
  <meta charset="utf-8" />
  <title>${V(e)}</title>
