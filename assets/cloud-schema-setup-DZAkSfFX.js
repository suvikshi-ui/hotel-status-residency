import{Gt as e,Ht as t}from"./store-B1mAFMim.js";import{r as n}from"./utils-BOasLFep.js";import{$ as r,B as i,D as a,nt as o}from"./index-CGMhp3OJ.js";import{n as s,t as c}from"./0009_desk_can_save-nl1VR0ed.js";var l=e(t(),1),u=`-- Hotel Status Residency — per-user cash book
...
`,b=n();function x({userId:e}){let[t,n]=(0,l.useState)(!1);return(0,b.jsxs)(`div`,{className:`flex flex-wrap gap-2`,children:[(0,b.jsx)(a,{type:`button`,onClick:()=>{let e=`${u}\n\n${d}\n\n${f}\n\n${p}\n\n${m}\n\n${h}\n\n${g}\n\n${c}\n\n${_}\n\n${v}\n\n${y}`;s(e)?r.success(`SQL copied. Paste it in the SQL editor, run it, then retry.`):r.error(`Copy blocked on this computer. Open the SQL box on Register instead.`)},children:`Copy table SQL`}),(0,b.jsx)(a,{type:`button`,variant:`outline`,asChild:!0,children:(0,b.jsx)(`a`,{href:o,target:`_blank`,rel:`noreferrer`,children:`Open SQL editor`})}),e?(0,b.jsx)(a,{type:`button`,variant:`outline`,disabled:t,onClick:()=>{n(!0),i(e).finally(()=>n(!1))},children:t?`Checking…`:`Tables are ready`}):null]})}export{d as i,y as n,f as r,x as t};