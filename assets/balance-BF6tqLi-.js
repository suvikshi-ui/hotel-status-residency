import{Dt as e,G as t,Lt as n,Pt as r,V as i,bt as a,dt as o,ft as s,i as c,mt as l,r as u,yt as d}from"./store-caTd5CU9.js";import{r as f,t as p}from"./utils-DdXx0uJ9.js";import{a as m,i as h,n as g,o as _,r as v,s as y,t as b}from"./select-8fCPtymG.js";import{t as x}from"./printer-DLsG5UXM.js";import{a as S,i as C,n as w,r as T,t as E}from"./balance-Bkws_qwg.js";import{t as D}from"./trash-2-C2xc4vuW.js";import{D as O,J as k,a as A,i as j,o as M,tt as N}from"./index-Z_llWdM6.js";import{t as P}from"./badge-BdPSjpPq.js";import{n as F,t as I}from"./card-Dh_TYGnL.js";import{i as L,n as R,r as z,t as B}from"./tabs-ByUAGl47.js";import{t as V}from"./mode-badge-BtF1t4kc.js";import{t as H}from"./print-sheet-DLkQzmnS.js";import{n as U,t as ee}from"./save-cube-BAeRaG1A.js";var W=n(r());function G(e){return Math.round(e).toLocaleString(`en-IN`)}function K(t){return t.checkOut?e(t.checkOut):`Continue`}function q(e){return e.status===`paid`?`✓ Paid`:e.status===`partial`?`Partial · ${G(e.remaining)}`:`Open`}function J(e,t){let n=`<!doctype html>
<html>
<head>
  <meta charset="utf-8" />
  <title>${H(e)}</title>
